...
\subsection{习题4.17}
考虑到膨胀前后的粒子数不变, $N_{1} = N_{2}$
\[\begin{cases}
N_{1} = \frac{8 \pi V_{1}}{3 h^3} (2m)^{3/2} \mu_{0}^{3/2} \,; \\
N_{2} = \frac{8 \pi V_{2}}{3 h^3} (2m)^{3/2} \mu^{3/2} \big[ 1 + \frac{\pi^2}{8}\big( \frac{k_{B} T}{\mu} \big)^2 + \cdots \big] \,,
\end{cases}\]
\[ \Rightarrow \quad{} \mu^{3/2} \approx \frac{V_1}{V_2} \mu_{0}^{3/2} \big[ 1 - \frac{\pi^2}{8} \big( \frac{k_{B} T}{\mu} \big)^2 \big] \,. \]
显然, 膨胀前后内能也不发生改变, $E_1 = E_2$
